...
<p align="left">
  <img src="https://github.com/user-attachments/assets/3a6785be-25a2-4c4b-8402-a12a2ea96d72" weight="300">
</p>
...
### 🔑 커널 (Kernel)
- 운영체제의 **핵심 구성 요소**
- 하드웨어 자원(프로세스, 메모리, 파일, 장치 등)을 **직접 관리**

### 📞 시스템 호출 (System Call)
- 커널이 제공하는 기능에 접근하는 **프로그래밍 인터페이스**
...
<p align="left">
  <img src="https://github.com/user-attachments/assets/377ec115-e210-4dc7-9fc1-cf08ccb0cb37" weight="600">
</p>

### 🧮 프로세스 관리 (Process Management)
- 여러 프로그램이 동시에 실행될 수 있도록 **CPU 스케줄링 및 실행 제어**

### 📁 파일 관리 (File Management)
- 저장장치에 **파일 시스템을 구성**하고 파일을 관리

### 💾 메모리 관리 (Memory Management)
- **효율적인 메인 메모리 사용**을 위한 관리

### 📡 통신 관리 (Communication Management)
- **네트워크를 통해 정보 송수신을 관리**

### 🎮 주변장치 관리 (Device Management)
- 모니터, 키보드, 마우스 등의 **하드웨어 장치를 관리**

---

> ✅ 유닉스는 단순하지만 강력한 철학을 바탕으로, 지금까지도 다양한 시스템에서 널리 사용되는 고성능 운영체제입니다.
